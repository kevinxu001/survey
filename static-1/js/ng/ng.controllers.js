		...
		$scope.items = [
			{
				title: 'Msgs',
				count: 14, 
				src: '/static/smart1.4.1/angularjs/ajax/notify/mail.html',
			...
			},
			{
				title: 'Notify',
				count: 3,
				src: '/static/smart1.4.1/angularjs/ajax/notify/notifications.html'
			},
			{
				title: 'Tasks',
				count: 4,
				src: '/static/smart1.4.1/angularjs/ajax/notify/tasks.html',
				//active: true
			}
		];

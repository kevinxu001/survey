...
angular.module('app.main', [])
			...
			link: function(scope, element, attrs) {
				...
				var smartActions = {
				    ...
				    userLogout: function($this){
						...
						// ask verification
						$.SmartMessageBox({
							title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> 退出 <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "1</strong></span> ?",
							content : $this.data('logout-msg') || "退出后并关闭浏览器窗口有助提高安全性",
							buttons : '[取消][确定]'
				    ...
				    resetWidgets: function($this){
						...
						$.SmartMessageBox({
							...
							content : $.widresetMSG || "确认重置所有组件设置并清空本地缓存吗？",
							buttons : '[取消][确定]'
						}, function(ButtonPressed) {
	...
	.directive('ribbon', function() {
		return {
			restrict: 'A',
			link: function(scope, element, attrs) {
				element.append('<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-blueDark"></i></span> <form><legend class="no-padding margin-bottom-10">布局选项</legend><section><label><input name="subscription" id="smart-fixed-header" type="checkbox" class="checkbox style-0"><span>固定顶栏</span></label><label><input type="checkbox" name="terms" id="smart-fixed-navigation" class="checkbox style-0"><span>固定导航栏</span></label><label><input type="checkbox" name="terms" id="smart-fixed-ribbon" class="checkbox style-0"><span>固定面包屑导航栏</span></label><label><input type="checkbox" name="terms" id="smart-fixed-footer" class="checkbox style-0"><span>固定底栏</span></label><label><input type="checkbox" name="terms" id="smart-fixed-container" class="checkbox style-0"><span>使用<b>.container</b> <div class="font-xs text-right">(非响应式布局)</div></span></label><label style="display:block;"><input type="checkbox" id="smart-topmenu" class="checkbox style-0"><span><b>顶部</b>菜单</span></label> <span id="smart-bgimages"></span></section><section><h6 class="margin-top-10 semi-bold margin-bottom-5">清空本地缓存</h6><a href="javascript:void(0);" class="btn btn-xs btn-block btn-primary" id="reset-smart-widget"><i class="fa fa-refresh"></i>恢复初始状态</a></section> <h6 class="margin-top-10 semi-bold margin-bottom-5">系统样式</h6><section id="smart-styles"><a href="javascript:void(0);" id="smart-style-0" data-titleclass="green" class="btn btn-block btn-xs txt-color-white margin-right-5" style="background-color:#4E463F;"><i class="fa fa-check fa-fw" id="skin-checked"></i>默认样式</a><a href="javascript:void(0);" id="smart-style-1" data-titleclass="white" class="btn btn-block btn-xs txt-color-white" style="background:#3A4558;">黑色优雅</a><a href="javascript:void(0);" id="smart-style-2" data-titleclass="blue" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#fff;">高亮魅力</a><a href="javascript:void(0);" id="smart-style-3" data-titleclass="pink" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background:#f78c40">谷歌样式</a></section></form> </div>')

				// hide bg options
				var smartbgimage = "<h6 class='margin-top-10 semi-bold'>Background</h6><img src='/static/smart/img/pattern/graphy-xs.png' data-htmlbg-url='/static/smart/img/pattern/graphy.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='/static/smart/img/pattern/tileable_wood_texture-xs.png' width='22' height='22' data-htmlbg-url='/static/smart/img/pattern/tileable_wood_texture.png' class='margin-right-5 bordered cursor-pointer'><img src='/static/smart/img/pattern/sneaker_mesh_fabric-xs.png' width='22' height='22' data-htmlbg-url='/static/smart/img/pattern/sneaker_mesh_fabric.png' class='margin-right-5 bordered cursor-pointer'><img src='/static/smart/img/pattern/nistri-xs.png' data-htmlbg-url='/static/smart/img/pattern/nistri.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='/static/smart/img/pattern/paper-xs.png' data-htmlbg-url='/static/smart/img/pattern/paper.png' width='22' height='22' class='bordered cursor-pointer'>";
				$("#smart-bgimages")
				    .fadeOut();
	...
	.factory('localize', ['$http', '$rootScope', '$window', function($http, $rootScope, $window){
		var localize = {
			...
			getLangUrl: function(lang) {
				return '/static/smart/js/langs/' + lang.langCode + '.js';
			},
